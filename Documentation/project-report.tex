...
\textit{(a) Truncation}\\
Truncation utilizes elitism to select the best fit individuals. For each crossover, 2 best fit individuals are selected while survivor selection is based on selecting best fit individuals of population size to be carried ahead to the next generation.\\

\textit{(b) Binary Tournament}\\
Binary Tournament 
